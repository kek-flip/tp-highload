...
|      Text       | Текст. Хранит как исходные, так и переведенные. В эту же таблицу добавлятся тексты с сайтов     | **77,5 млрд.** записей, **177 ТБайт** данных, в худшем случае - **354 ТБайт** |  105,75 тыс.  |       -       |
